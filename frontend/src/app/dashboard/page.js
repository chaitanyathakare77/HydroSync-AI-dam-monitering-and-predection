...
export default function DashboardPage() {
  ...
  if (!user)
    return (
      <div className="flex h-screen w-full items-center justify-center bg-gradient-to-br from-blue-50 to-purple-50 text-blue-600">
  ...
  return (
    <div className="flex h-screen w-full overflow-hidden bg-gradient-to-br from-gray-50 to-blue-50 font-sans text-gray-900">
      ...
      <aside className="relative z-[1100] flex h-full w-64 shrink-0 flex-col border-r border-gray-200 bg-white shadow-sm">
        ...
        <div className="flex items-center gap-3 border-b border-gray-200 px-5 py-5">
          <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-blue-500 to-cyan-400 shadow-md shadow-blue-200">
            ...
            return (
              <button
                ...
                className={`group relative flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-left text-sm transition-all duration-200 ${isActive
                  ? "bg-gradient-to-r from-blue-100 to-cyan-50 text-blue-700 shadow-sm"

    ...
    return (
      <div className="flex h-screen w-full items-center justify-center bg-linear-to-br from-blue-50 to-purple-50 text-blue-600">
        <div className="flex flex-col items-center gap-3">
          ...
          <span className="text-sm tracking-widest uppercase opacity-70">Loading Alerts…</span>
        </div>
      </div>
    )
  ...
  return (
    <div className="flex h-screen w-full overflow-hidden bg-linear-to-br from-gray-50 to-blue-50 font-sans text-gray-900">
      ...
      <main className="relative flex-1 overflow-hidden">
        <div className="p-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-4">Alerts & Warnings</h1>
          <p className="text-gray-600">This page will show alerts and warnings related to dam conditions.</p>
          {/* Add content here */}
        </div>
      </main>
    </div>
